...
![ArcGIS Online](https://img.shields.io/badge/ArcGIS%20Online-2C7AC3?style=for-the-badge)
![Remote Sensing](https://img.shields.io/badge/Remote%20Sensing-2E8B57?style=for-the-badge)
![STK](https://img.shields.io/badge/STK-Mission%20Simulation-1F4E79?style=for-the-badge)

`Spatial Analysis` `Geoprocessing` `Mapping` `Digitizing` `Raster & Vector Data` `GIS Data Management` `Orbit Simulation`
...
`NumPy` `Pandas` `Matplotlib` `Hugging Face` `Azure AI` `NLP` `GANs` `Data Preprocessing`
...
|------|--------------|--------|
| Machine Learning Intern | Digital Egypt Pioneers Initiative (DEPI) | Jun 2024 - Present |
| AI Intern | Elaraby Group | Aug 2023 - Sep 2023 |
| AI Intern | National Research Institute of Astronomy and Geophysics (NRIAG) | Sep 2023 |
...
- LinkedIn: [mahmoud-khaled1](https://linkedin.com/in/mahmoud-khaled1)
- GitHub: [Mahmoudkhaled17](https://github.com/Mahmoudkhaled17)
- Email: [mahmoudkhaedl1772001@gmail.com](mailto:mahmoudkhaedl1772001@gmail.com)
